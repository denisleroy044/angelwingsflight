    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="flex space-x-4 mb-4">
        <label className="flex items-center space-x-2">
          <input type="radio" value="round" {...register("tripType")} className="w-4 h-4 text-blue-600" />
          <span className="text-gray-700">Round Trip</span>
        </label>
        <label className="flex items-center space-x-2">
          <input type="radio" value="oneway" {...register("tripType")} className="w-4 h-4 text-blue-600" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div>
          <input {...register("origin")} placeholder="From" className="w-full p-3 border rounded focus:ring-2 focus:ring-blue-500" />
      ...
      <button type="submit" className="w-full bg-blue-600 text-white p-3 rounded hover:bg-blue-700">Search Flights</button>
    </form>
  )
}
